 ...
 * Use this command instead: `php pmtl.php check-db-structure`.
 * @since 2025-04-25
...
echo 'Warning! This file will be deleted in the future.' . PHP_EOL
    . 'Please use this command instead: `php pmtl.php check-db-structure`.' . PHP_EOL . PHP_EOL;
